...
suppressWarnings({
    fit_pt = birdie(r_probs$block, party_20 ~ (1 | GEOID_tract), data=d, family=cat_mixed(), prior=prior_mm, ctrl=ctrl)
    fit_t = birdie(r_probs$block, voted_20 ~ (1 | GEOID_tract), data=d, family=cat_mixed(), prior=prior_mm, ctrl=ctrl)
    fit_p = birdie(fitted(fit_t), party ~ voted_20 + (1 | GEOID_tract), data=d, family=cat_mixed(), prior=prior_mm, ctrl=ctrl)
})
